...
template <typename T>
rocblas_status rocsolver_larfb_impl(rocsolver_handle          handle,
                                    ...
                                    const rocsolver_int       lda)
{
    ...
    return rocsolver_larfb_template<T>(handle,
                                       side,
                                       trans,
                                       direct,
                                       m,
...
ROCBLAS_EXPORT rocsolver_status rocsolver_slarfb(rocsolver_handle          handle,
                                                 const rocsolver_side      side,
                                                 const rocsolver_operation trans,
                                                 const rocsolver_direct    direct,
                                                 const rocsolver_int       m,
                                                 ...
                                                 const rocsolver_int       lda)
{
    return rocsolver_larfb_impl<float>(
        handle, side, trans, direct, m, n, k, V, ldv, T, ldt, A, lda);
}

ROCBLAS_EXPORT rocsolver_status rocsolver_dlarfb(rocsolver_handle          handle,
                                                 const rocsolver_side      side,
                                                 const rocsolver_operation trans,
                                                 const rocsolver_direct    direct,
                                                 const rocsolver_int       m,
                                                 ...
                                                 const rocsolver_int       lda)
{
    return rocsolver_larfb_impl<double>(
        handle, side, trans, direct, m, n, k, V, ldv, T, ldt, A, lda);
}
