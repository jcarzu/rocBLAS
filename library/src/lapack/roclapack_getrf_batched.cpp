...
ROCBLAS_EXPORT rocblas_status rocsolver_sgetrf_batched(rocsolver_handle    handle,
...
ROCBLAS_EXPORT rocblas_status rocsolver_dgetrf_batched(rocsolver_handle    handle,
                                                       const rocsolver_int m,
                                                       const rocsolver_int n,
                                                       double* const       A[],
                                                       const rocsolver_int lda,
