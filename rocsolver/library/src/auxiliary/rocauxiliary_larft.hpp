...
__global__ void set_triangular(const rocblas_int k,
                               U                 V,
                               const rocblas_int shiftV,
                               const rocblas_int ldv,
                               const rocblas_int strideV,
                               T*                tau,
                               const rocblas_int strideT,
                               T*                F,
                               const rocblas_int ldf,
                               const rocblas_int strideF)
{
...
template <typename T>
__global__ void set_tau(const rocblas_int k, T* tau, const rocblas_int strideT)
{
    const auto blocksize = hipBlockDim_x;
                                        ...
                                        const rocblas_int    batch_count)
{
    ...
    hipLaunchKernelGGL(set_triangular,
                       dim3(blocks, blocks, batch_count),
                       dim3(32, 32),
                       0,
                       stream,
                       k,
