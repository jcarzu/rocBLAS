...
inline rocblas_status
    rocsolver_larfg(rocblas_handle handle, rocblas_int n, T* alpha, T* x, rocblas_int incx, T* tau);

template <>
inline rocblas_status rocsolver_larfg(
    rocblas_handle handle, rocblas_int n, float* alpha, float* x, rocblas_int incx, float* tau)
{
...
template <>
inline rocblas_status rocsolver_larfg(
    rocblas_handle handle, rocblas_int n, double* alpha, double* x, rocblas_int incx, double* tau)
{
...
template <>
inline rocblas_status rocsolver_potf2(
...
template <typename T>
inline rocblas_status rocsolver_getf2(rocblas_handle handle,
                                      rocblas_int    m,
                                      rocblas_int    n,
                                      T*             A,
                                      rocblas_int    lda,
...
template <typename T>
inline rocblas_status rocsolver_getf2_batched(rocblas_handle handle,
                                              rocblas_int    m,
                                              rocblas_int    n,
                                              T* const       A[],
                                              rocblas_int    lda,
...
template <typename T>
inline rocblas_status rocsolver_getf2_strided_batched(rocblas_handle handle,
                                                      rocblas_int    m,
                                                      rocblas_int    n,
                                                      T*             A,
                                                      rocblas_int    lda,
...
inline rocblas_status rocsolver_getf2_strided_batched(rocblas_handle handle,
                                                      ...
                                                      rocblas_int    batch_count)
{
    return rocsolver_sgetf2_strided_batched(
...
inline rocblas_status rocsolver_getf2_strided_batched(rocblas_handle handle,
                                                      ...
                                                      rocblas_int    batch_count)
{
    return rocsolver_dgetf2_strided_batched(
        handle, m, n, A, lda, strideA, ipiv, stridep, info, batch_count);
}
...
template <typename T>
inline rocblas_status rocsolver_getrf(rocblas_handle handle,
                                      rocblas_int    m,
                                      rocblas_int    n,
                                      T*             A,
                                      rocblas_int    lda,
...
template <typename T>
inline rocblas_status rocsolver_getrf_batched(rocblas_handle handle,
                                              rocblas_int    m,
                                              rocblas_int    n,
                                              T* const       A[],
                                              rocblas_int    lda,
...
template <typename T>
inline rocblas_status rocsolver_getrf_strided_batched(rocblas_handle handle,
                                                      rocblas_int    m,
                                                      rocblas_int    n,
                                                      T*             A,
                                                      rocblas_int    lda,
...
inline rocblas_status rocsolver_getrf_strided_batched(rocblas_handle handle,
                                                      ...
                                                      rocblas_int    batch_count)
{
    return rocsolver_sgetrf_strided_batched(
        handle, m, n, A, lda, strideA, ipiv, stridep, info, batch_count);
}
...
inline rocblas_status rocsolver_getrf_strided_batched(rocblas_handle handle,
                                                      ...
                                                      rocblas_int    batch_count)
{
    return rocsolver_dgetrf_strided_batched(
        handle, m, n, A, lda, strideA, ipiv, stridep, info, batch_count);
}
...
template <typename T>
inline rocblas_status rocsolver_getrs(rocblas_handle     handle,
                                      rocblas_operation  trans,
                                      rocblas_int        n,
                                      rocblas_int        nrhs,
                                      const T*           A,
...
template <typename T>
inline rocblas_status rocsolver_geqr2(
    rocblas_handle handle, rocblas_int m, rocblas_int n, T* A, rocblas_int lda, T* ipiv);

template <>
inline rocblas_status rocsolver_geqr2(
    rocblas_handle handle, rocblas_int m, rocblas_int n, float* A, rocblas_int lda, float* ipiv)
{
...
template <>
inline rocblas_status rocsolver_geqr2(
    rocblas_handle handle, rocblas_int m, rocblas_int n, double* A, rocblas_int lda, double* ipiv)
{
...
template <typename T>
inline rocblas_status rocsolver_geqr2_batched(rocblas_handle handle,
                                              rocblas_int    m,
                                              rocblas_int    n,
                                              T* const       A[],
                                              rocblas_int    lda,
...
template <typename T>
inline rocblas_status rocsolver_geqr2_strided_batched(rocblas_handle handle,
                                                      rocblas_int    m,
                                                      rocblas_int    n,
                                                      T*             A,
                                                      rocblas_int    lda,
...
inline rocblas_status rocsolver_geqr2_strided_batched(rocblas_handle handle,
                                                      ...
                                                      rocblas_int    batch_count)
{
    return rocsolver_sgeqr2_strided_batched(
...
inline rocblas_status rocsolver_geqr2_strided_batched(rocblas_handle handle,
                                                      ...
                                                      rocblas_int    batch_count)
{
    return rocsolver_dgeqr2_strided_batched(
        handle, m, n, A, lda, strideA, ipiv, stridep, batch_count);
}
...
template <typename T>
inline rocblas_status rocsolver_geqrf(
    rocblas_handle handle, rocblas_int m, rocblas_int n, T* A, rocblas_int lda, T* ipiv);
...
template <typename T>
inline rocblas_status rocsolver_geqrf_batched(rocblas_handle handle,
                                              rocblas_int    m,
                                              rocblas_int    n,
                                              T* const       A[],
                                              rocblas_int    lda,
...
template <typename T>
inline rocblas_status rocsolver_geqrf_strided_batched(rocblas_handle handle,
                                                      rocblas_int    m,
                                                      rocblas_int    n,
                                                      T*             A,
                                                      rocblas_int    lda,
...
inline rocblas_status rocsolver_geqrf_strided_batched(rocblas_handle handle,
                                                      ...
                                                      rocblas_int    batch_count)
{
    return rocsolver_sgeqrf_strided_batched(
        handle, m, n, A, lda, strideA, ipiv, stridep, batch_count);
}
...
inline rocblas_status rocsolver_geqrf_strided_batched(rocblas_handle handle,
                                                      ...
                                                      rocblas_int    batch_count)
{
    return rocsolver_dgeqrf_strided_batched(
        handle, m, n, A, lda, strideA, ipiv, stridep, batch_count);
}
