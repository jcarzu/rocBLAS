...
{
    // Print Version
    char solver_version[100];
    rocblas_get_version_string(solver_version, sizeof(solver_version));
    printf("rocSOLVER version: %s\n\n", solver_version);
    ...
    // Set data file path
    rocblas_parse_data(argc, argv, rocblas_exepath() + "rocsolver_gtest.data");
